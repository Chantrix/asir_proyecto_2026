...
docker exec --user www-data nextcloud-asir php occ config:system:set trusted_domains 1 --value=$DOMINIO_COMPLETO
docker exec --user www-data nextcloud-asir php occ config:system:set overwritehost --value=$DOMINIO_COMPLETO
